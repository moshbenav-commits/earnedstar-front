...
import { StripeSubscribeButton } from "@/components/dashboard/stripe-subscribe-button";
import { resolveBillingProvider } from "@/lib/payments/billing-provider";
...
import { B2bSettingsForm } from "@/components/dashboard/b2b-settings-form";
  ...
  return (
    <>
      ...
      <main className="space-y-8 bg-bg p-4 md:p-8">
        ...
        <B2bSettingsForm
          initial={{
            b2b_mode_enabled: profile.b2b_mode_enabled,
            b2b_default_delay_days: profile.b2b_default_delay_days,
          }}
        />
        ...
        {resolveBillingProvider() === "stripe" ? (
          <StripeSubscribeButton currentPlan={plan} />
        ) : (

...
import { LayoutDashboard, Star, Send, BarChart2, Layout, Settings, LogOut, Lock, Plug, Share2, Building2, HelpCircle, Users, ScanSearch, ShieldCheck, Gift } from "lucide-react";
...
const navItems = [
  ...
  { href: "/ops/dashboard", label: "Go Tianguis Ops", icon: ScanSearch },
  ...
  { href: "/dashboard/loyalty", label: "Loyalty & Referrals", icon: Gift, lockStarter: true },

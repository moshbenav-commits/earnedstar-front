...
/** Horizontal SVG lockups (email / legacy embeds) */
...
/** Default share card for link previews when no merchant logo is set */
export const DEFAULT_SHARE_IMAGE_URL = "https://earnedstar.com/opengraph-image";
